...
-- CreateEnum
CREATE TYPE "JournalEntrySource" AS ENUM ('MANUAL', 'INVOICE', 'PAYMENT', 'DISCOUNT', 'REFUND', 'PAYROLL');

-- AlterTable
ALTER TABLE "fee_categories" ADD COLUMN     "revenueAccountId" TEXT;
...
-- CreateIndex
CREATE INDEX "journal_lines_organizationId_idx" ON "journal_lines"("organizationId");
...
-- AddForeignKey
ALTER TABLE "fee_categories" ADD CONSTRAINT "fee_categories_revenueAccountId_fkey" FOREIGN KEY ("revenueAccountId") REFERENCES "accounts"("id") ON DELETE SET NULL ON UPDATE CASCADE;
