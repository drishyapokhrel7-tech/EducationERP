...
const WARNING = new Set([
  ...
  "PARTIAL", "PARTIALLY_PAID", "PENDING", "POSSIBLE_MATCH", "REQUESTED",
  "SCHEDULED", "SUBMITTED", "UNDER_REVIEW", "UNEMPLOYED_SEEKING",
]);

const DESTRUCTIVE = new Set([
  "ABSENT", "CANCELED", "CANCELLED", "DEACTIVATED", "DECLINED", "FAILED",
  "INACTIVE", "OVERDUE", "REJECTED", "REVOKED", "SUSPENDED", "TERMINATED",
