...
// by the billing page and the profile popover's tier badge, not just
// Students, so every caller shares one SWR cache entry under the same
// key instead of each page re-fetching independently.
