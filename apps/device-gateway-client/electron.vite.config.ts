...
export default defineConfig({
  main: {
    ...
    // apps/exam-client/apps/cctv-client — see either app's identical
    // comment for the full reasoning (Node's strip-only TS loader
    // can't handle ApiError's constructor parameter properties).
